            ...
            <div class="row no-gutters">
                <div class="content col-xl-5 d-flex align-items-stretch">
                    <div class="content">
                        <h3>HKYSA是什麼組織?</h3>
                        <p>
                            在2023成立之前，我們的主要服務是青年培訓。我們認識到近年來年輕人的發展和成長
                        </p>
                        <a href="{{ url('/about-us') }}" class="about-btn"><span>關於我們</span> <i class="bx bx-chevron-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-7 d-flex align-items-stretch">
                    <div class="icon-boxes d-flex flex-column justify-content-center">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        香港青年支援協會對塑造我的職業生涯起到了關鍵作用。通過他們的課程，我獲得了在我的領域中脫穎而出所需的技能。提供的支持服務為我
                                        提供了寶貴的指導和動力。由於他們的項目，我現在有能力追求自己的夢想。
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        我感激香港青年支援協會。他們的讚助和資金使我有可能接受職業培訓。該協會不僅提供了財務支持，還提供了持續的指導。今天，我擁有一個
                                        有意義的職業，我要歸功於他們。
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        香港青年支援協會是一盞希望之燈。他們的咨詢服務幫助我應對個人挑戰。該協會致力於全面發展，改變了我的生活和他人的生活。我永遠感激他們的支持。
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        香港青年支援協會是一個改變遊戲規則的機構。他們的培訓課程使我能夠探索行業並發現我的熱情。我獲得的知識和技能在確保工作方面具有無價值。我感激
                                        他們對我們成長的奉獻。
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        我感激香港青年支援協會。在他們的指導下，我獲得了自信，可以應對面試並展示我的技能。今天，我在我的職業中蓬勃發展，我要把我成功的重要部分歸
                                        功於他們。謝謝！
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
