                    ...
                    <div class="portfolio-details-slider swiper">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ config('app.url') }}img/portfolio/portfolio-details-1.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ config('app.url') }}img/portfolio/portfolio-details-2.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ config('app.url') }}img/portfolio/portfolio-details-3.jpg" alt="">
                            </div>
