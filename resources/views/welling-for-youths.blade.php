                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry">
                        ...
                        <h2 class="entry-title">
                            <a href="{{ url('/blog-single') }}">Dolorum optio tempore voluptas dignissimos cumque fuga qui
                                quibusdam quia</a>
                        </h2>
                        ...
                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                        href="{{ url('/blog-single') }}">John Doe</a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                        href="{{ url('/blog-single') }}">
                                        <time datetime="2020-01-01">Jan 1, 2020</time>
                                    </a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a
                                        href="{{ url('/blog-single') }}">12 Comments</a></li>
                            </ul>
                        </div>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ config('app.url') }}img/blog/blog-2.jpg" alt="" class="img-fluid">
                        </div>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ config('app.url') }}img/blog/blog-3.jpg" alt="" class="img-fluid">
                        </div>

                        <h2 class="entry-title">
                            <a href="{{ url('/blog-single') }}">Possimus soluta ut id suscipit ea ut. In quo quia et soluta
                                libero sit sint.</a>
                        </h2>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ config('app.url') }}img/blog/blog-4.jpg" alt="" class="img-fluid">
                        </div>

                        <h2 class="entry-title">
                            <a href="{{ url('/blog-single') }}">Non rem rerum nam cum quo minus. Dolor distinctio deleniti
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item recent-posts">
                            ...
                            <div class="post-item clearfix">
                                ...
                                <h4><a href="{{ url('/blog-single') }}">Id quia et et ut maxime similique occaecati ut</a>
                                </h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>
